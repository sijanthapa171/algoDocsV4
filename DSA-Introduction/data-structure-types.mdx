...
<img
  style={{ borderRadius: '0.5rem' }}
  src="graph-data-structure.png"
/>

<ResponseField name="Popular Graph Based Data Structures:" >
  <Expandable title="Data Structures">
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="trees-data-structure.png"
/>

<ResponseField name="Popular Tree based Data Structure" >
  <Expandable title="Data Structures">
    <ResponseField type="string">
      * Binary Tree
    </ResponseField>
...
<Columns cols={2}>
  <Card title="Linear Data Structures">
  ...
  <Card title="Non Linear Data Structures">
...
<Note>Note: Choosing the wrong data structure can lead to inefficient code which can lead to high memory consumption and time complexity.</Note>