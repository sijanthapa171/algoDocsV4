...
<img
  ...
  src="removing-highest-priority-element.png"
/>
...
<Note> Before studying the priority queue, please refer to the heap data structure for a better understanding of binary heap as it is used to implement the priority queue in this article.</Note>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="insert-element-end-the-queue.png"
/>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="heapify-after-insertion.png"
/>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="select-element-deleted.png"
/>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="swap-with-the-last-leaf-node-element.png"
/>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="remove-the-last-element-leaf.png"
/>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="heapify-the-priority-queue.png"
/>
