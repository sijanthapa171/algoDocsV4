...
description: 'Overview of Linked List Data Structure'
---
...
<Note> Note: You might have played the game Treasure Hunt, where each clue includes the information about the next clue. That is how the linked list operates. </Note>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="linked-list-representation.png"
/>
