---
title: 'B+ Tree'
description: 'Overview of B+ Trees'
---
...
<img
  ...
  src="multilevel-Indexing-using-B+-tree.png"
/>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="k-is-not-found-at-the-root.png"
/>
...
<img
  style={{ borderRadius: '0.5rem' }}
  src="go-to-right-of-the-root.png"
/>
...
If binary search is used, then total complexity is ```Θ(log 2 t.logt n)```.
